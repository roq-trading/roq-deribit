...
template <>
struct fmt::formatter<roq::deribit::protocol::sbe::Config::Connection> {
  constexpr auto parse(format_parse_context &context) { return std::begin(context); }
  auto format(roq::deribit::protocol::sbe::Config::Connection const &value, format_context &context) const {
...
template <>
struct fmt::formatter<roq::deribit::protocol::sbe::Config> {
  constexpr auto parse(format_parse_context &context) { return std::begin(context); }
  auto format(roq::deribit::protocol::sbe::Config const &value, format_context &context) const {
    using namespace std::literals;
    return fmt::format_to(
        context.out(),
        R"({{)"
