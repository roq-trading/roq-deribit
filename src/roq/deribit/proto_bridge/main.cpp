...
#include "roq/deribit/proto_bridge/application.hpp"
...
auto const INFO = roq::Service::Info{
    .description = "Roq's Deribit gateway (Protobuf interface)"sv,
...
int main(int argc, char **argv) {
  ...
  return roq::deribit::proto_bridge::Application{args, settings, INFO}.run();
}
