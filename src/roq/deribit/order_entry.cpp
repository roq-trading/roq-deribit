...
uint16_t OrderEntry::operator()(
  ...
  auto new_order_single = fix::NewOrderSingle{
      ...
      .side = side,
      .order_qty = {create_order.quantity, order.quantity_precision.decimals},
      .price = {create_order.price, order.price_precision.decimals},
      .symbol = create_order.symbol,
      .exec_inst = exec_inst,
      .ord_type = ord_type,
      .time_in_force = time_in_force,
      .stop_px = {create_order.stop_price, order.price_precision.decimals},
...
uint16_t OrderEntry::operator()(
  ...
  auto order_cancel_replace_request = fix::OrderCancelReplaceRequest{
      ...
      .currency = {},
      .side = side,
      .order_qty = {modify_order.quantity, order.quantity_precision.decimals},
      .ord_type = ord_type,
      .price = {modify_order.price, order.price_precision.decimals},
      .exec_inst = {},
      .deribit_mm_protection = {},
  };
