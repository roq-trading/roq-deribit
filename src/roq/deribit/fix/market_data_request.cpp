...
core::utils::Message MarketDataRequest::encode(
  ...
  writer
    .write(
        core::fix::Field::MD_REQ_ID,
        md_req_id)
    .write(
        core::fix::Field::SUBSCRIPTION_REQUEST_TYPE,
        core::fix::SubscriptionRequestType::SNAPSHOT_UPDATES)
    .write(
        core::fix::Field::MARKET_DEPTH,
        MARKET_DEPTH)
    .write(
        core::fix::Field::MD_UPDATE_TYPE,
        core::fix::MDUpdateType::INCREMENTAL_REFRESH)
    .write(
        static_cast<uint32_t>(fix::Deribit::TRADE_AMOUNT),
        0)
    .write(
        static_cast<uint32_t>(fix::Deribit::SINCE_TIMESTAMP),
        0)
    .write(
        core::fix::Field::NO_MD_ENTRY_TYPES,
        3)
    .write(
        core::fix::Field::MD_ENTRY_TYPE,
        core::fix::MDEntryType::BID)
    .write(
        core::fix::Field::MD_ENTRY_TYPE,
