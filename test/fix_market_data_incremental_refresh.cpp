...
TEST(fix_market_data_incremental_refresh, parse_message_1) {
  const auto message =
      ...
      ".0000\001272=20190907-15:37:00.896\00110=241\001"_sv;
  ...
  auto bytes = core::fix::Reader<core::fix::Version::FIX_44>::dispatch(
      [&](const core::fix::message_t &message) {
        ...
        EXPECT_EQ(result.symbol, "BTC-27SEP19"_sv);
        ...
        EXPECT_EQ(result.md_req_id, "123"_sv);
...
TEST(fix_market_data_incremental_refresh, parse_message_2) {
  ...
  auto bytes = core::fix::Reader<core::fix::Version::FIX_44>::dispatch(
      [&](const core::fix::message_t &message) {
        ...
        EXPECT_EQ(item_0.deribit_trade_id, "18254681"_sv);
        EXPECT_EQ(item_0.side, core::fix::Side::BUY);
        EXPECT_EQ(item_0.order_id, "0"_sv);
        EXPECT_EQ(item_0.secondary_order_id, "0"_sv);
        EXPECT_EQ(item_0.ord_status, core::fix::OrdStatus::FILLED);
        EXPECT_DOUBLE_EQ(item_0.index_price, 10445.93);
        EXPECT_EQ(item_0.text, "2889354"_sv);
        // item 1
        ...
        EXPECT_EQ(item_1.deribit_trade_id, "18254682"_sv);
        EXPECT_EQ(item_1.side, core::fix::Side::BUY);
        EXPECT_EQ(item_1.order_id, "0"_sv);
        EXPECT_EQ(item_1.secondary_order_id, "0"_sv);
        EXPECT_EQ(item_1.ord_status, core::fix::OrdStatus::FILLED);
        EXPECT_DOUBLE_EQ(item_1.index_price, 10445.93);
        EXPECT_EQ(item_1.text, "2889355"_sv);
        // item 2
        ...
        EXPECT_EQ(item_2.deribit_trade_id, "18254683"_sv);
        EXPECT_EQ(item_2.side, core::fix::Side::BUY);
        EXPECT_EQ(item_2.order_id, "0"_sv);
        EXPECT_EQ(item_2.secondary_order_id, "0"_sv);
        EXPECT_EQ(item_2.ord_status, core::fix::OrdStatus::FILLED);
        EXPECT_DOUBLE_EQ(item_2.index_price, 10445.93);
        EXPECT_EQ(item_2.text, "2889356"_sv);
        // item 3
        ...
        EXPECT_EQ(item_3.deribit_trade_id, "18254684"_sv);
        EXPECT_EQ(item_3.side, core::fix::Side::BUY);
        EXPECT_EQ(item_3.order_id, "0"_sv);
        EXPECT_EQ(item_3.secondary_order_id, "0"_sv);
        EXPECT_EQ(item_3.ord_status, core::fix::OrdStatus::FILLED);
        EXPECT_DOUBLE_EQ(item_3.index_price, 10445.93);
        EXPECT_EQ(item_3.text, "2889357"_sv);
        // item 4
        ...
        EXPECT_EQ(item_4.deribit_trade_id, "18254685"_sv);
        EXPECT_EQ(item_4.side, core::fix::Side::BUY);
        EXPECT_EQ(item_4.order_id, "0"_sv);
        EXPECT_EQ(item_4.secondary_order_id, "0"_sv);
...
TEST(fix_market_data_incremental_refresh, parse_message_3) {
  const auto message =
      ...
      "0\001198=0\00139=1\00144=170.3600\00158=586940\00110=030\001"_sv;
  core::Buffer buffer(4096);
  core::fix::Buffer decode_buffer(buffer);
  int results = 0;
  auto bytes = core::fix::Reader<core::fix::Version::FIX_44>::dispatch(
      [&](const core::fix::message_t &message) {
        ...
        EXPECT_EQ(message.header.msg_type, core::fix::MsgType::MARKET_DATA_INCREMENTAL_REFRESH);
        auto result = fix::MarketDataIncrementalRefresh::create(message, decode_buffer);
        EXPECT_EQ(result.symbol, "ETH-PERPETUAL"_sv);
        EXPECT_EQ(result.no_md_entries.size(), size_t{1});
        // item 0
        auto &item_0 = result.no_md_entries[0];
        EXPECT_EQ(item_0.md_update_action, core::fix::MDUpdateAction::NEW);
        ...
        EXPECT_EQ(item_0.deribit_trade_id, "ETH-1192275"_sv);
        EXPECT_EQ(item_0.side, core::fix::Side::BUY);
        EXPECT_EQ(item_0.order_id, "0"_sv);
        EXPECT_EQ(item_0.secondary_order_id, "0"_sv);
